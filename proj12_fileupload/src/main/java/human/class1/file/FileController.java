...
public class FileController {
	...
	public String uplaod(MultipartHttpServletRequest req) {
		...
		try {
			...
			String safeFileName = path + "//" + System.currentTimeMillis() + "_"
					+ fileName;
	...
	public String uplaods(MultipartHttpServletRequest req) {
