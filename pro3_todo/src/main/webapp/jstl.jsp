...
<body>
	...
	기본적으로 el은 page > request > session > application game : ${game }
	...
	<hr>
	end가 items 개수보다 크면 items 끝까지만 돌고 에러없음
	<br>
	...
	<hr>
	<a
		href="https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=검색"
		target="_blank">네이버 검색</a>
	<br>
	<a href=http://localhost:8080/_pro3_todo/jstl.jsp">jstl페이지로 이동</a>
	<br>
	<a href=/_prj3_todo/jstl.jsp">jstl페이지로 이동</a>
	<br>

	<h1>c:url 사용하는 이유</h1>
	1. 영어나 숫자 외 한글이나 특수문자응 인코드 해줌 <br>
	2.  context path 자동추가(/_proj3_todo)<br>
